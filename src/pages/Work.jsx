    ...
    return (
        ...
        >
            ...
            <motion.div
                ...
                className="mb-12 md:mb-16 border-b border-cyan-900/50 pb-6 md:pb-8"
            >
                <div className="flex items-center gap-2 text-cyan-500 mb-2">
                    <FolderGit2 size={24} className="w-5 h-5 md:w-6 md:h-6" />
                    <span className="text-xs md:text-sm font-bold tracking-widest uppercase">/root/projects/all</span>
                </div>
                <h1 className="text-3xl md:text-5xl font-black tracking-tighter mb-4 text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-600 holo-text break-words">
                    PROJECT_ARCHIVE
                </h1>
                <p className="text-base md:text-xl text-cyan-200/70 max-w-3xl leading-relaxed">
